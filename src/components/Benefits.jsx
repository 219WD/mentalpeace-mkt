    ...
    <section id="beneficios" className="benefits-section">
      ...
      <div className="benefit-cards">
        <div className="benefit-card">
          <FontAwesomeIcon icon={faStethoscope} size="3x" /> {/* Cambiamos el ícono */}
        ...
        <div className="benefit-card">
          <FontAwesomeIcon icon={faUserMd} size="3x" /> {/* Cambiamos el ícono */}
        ...
        <div className="benefit-card">
          <FontAwesomeIcon icon={faBaby} size="3x" /> {/* Cambiamos el ícono */}
        ...
        <div className="benefit-card">
          <FontAwesomeIcon icon={faTooth} size="3x" /> {/* Cambiamos el ícono */}
